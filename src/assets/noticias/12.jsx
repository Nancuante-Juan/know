export function Devolver() { return (
	<div className="NOTICIA_CONTENT">
        El Gobierno aprobó este miércoles el ingreso al RIGI de un proyecto de la empresa Tecpetrol, del Grupo Techint, para producir petróleo en Vaca Muerta. La inversión comprometida alcanza los US$6.400 millones.

        <br />Así lo comunicó en sus redes el ministro de Economía, Luis Caputo, quien celebró el avance de la iniciativa Los Toldos II Este. Según explicó el funcionario, el proyecto prevé producir 70.000 barriles diarios de petróleo y generará 3100 empleos directos y 4800 indirectos.

        <br />“El RIGI no solo acelerará el ritmo del desarrollo, sino que además permitirá que se incrementen en aproximadamente un 40% los recursos a ser desarrollados en el área”, remarcó Caputo.
        ...
        <h1>El optimismo del Gobierno detrás del Régimen de Incentivo a las Grandes Inversiones</h1>

        <br />Según datos compartidos por el ministro de Economía, el Gobierno ya ha recibido 43 proyectos para ingresar al RIGI por un monto total de US$148.229 millones. De esa cifra, 23 ya fueron aprobados bajo la promesa de invertir US$49.766 millones.
        ...
        <br />“La gente y nosotros somos optimistas; 2027 será muy positivo”, sostuvo Caputo, y agregó: “El flujo de dólares es cada vez más alto, esto garantiza que no vamos a tener problemas en el tipo de cambio, como supimos tener en el pasado, van a estar entrando muchas más inversiones”.
    </div>
); }