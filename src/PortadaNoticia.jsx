...
if (grande) { return (
	<div className={"flex flex-col w-full h-96 justify-end bg-cover bg-center text-white muestra-noticia muestra-noticia-grande"} style={{backgroundImage: "url("+imagen+")",}}>
	...
	<div className={"flex flex-col w-full h-96 justify-end bg-cover bg-center text-white muestra-noticia muestra-noticia-pequena"} style={{backgroundImage: "url("+imagen+")",}}>
