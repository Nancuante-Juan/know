...
export default function PersonalizarLecturaPopup() {
	return (
		<div className="">
			<div className="flex flex-col fixed top-4 right-4 w-120 bg-white ow-the-edge z-20 overflow-x-hidden overflow-y-auto" style={{minHeight: "calc(100vh - 2rem)", maxHeight: "calc(100vh - 2rem)", maxWidth: "calc(100vw - 2rem)"}}>
