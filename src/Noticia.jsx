...
export default function Noticia () {
	...
	return (
		<div className="bg-black">
			<BarraNavegación />
			<div className="flex flex-col w-screen h-[64svh] md:h-[74svh] bg-cover text-white justify-end bg-center trans select-text overflow-hidden" style={{backgroundImage: "url("+`/${NOTI_INFO.imagen}`+")"}}>
