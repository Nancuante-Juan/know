...
export default function DefaultGrid({children, tipo="", cara, seccion, url, invertir=false}){
	if (invertir) { invertir = "flex-row-reverse" }
	...
	<div className="flex flex-col snap-center">
		...
		<div className={"flex gap-4 md:p-4 md:pt-0 w-full snap-center "+invertir} style={{ maxHeight: "calc(100vh - 52px)", minHeight: "calc(100vh - 52px)"}}>
			{cara}
