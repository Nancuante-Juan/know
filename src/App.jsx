...
<div className="grid grid-cols-3 gap-4 p-4 pt-0 min-h-dvh bg-black">
	<PortadaNoticia titulo="El precio del oro alcanza nuevos máximos" imagen={"src/assets/fotos/tiempo_sur/foto_2.jpg"} medio="Tiempo Sur" categorias="Economia" descripcion="El oro se mantiene en un constante ascenso, generando interés en los inversores." grande={true} />
